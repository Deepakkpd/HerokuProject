...
<script type="text/javascript">
	function contactSubmit(){
		alert("inside");
		$('#helloForm').attr('action', '${pageContext.request.contextPath}/contact');
		alert("inside 2");
		$('#helloForm').submit();
		alert("inside 3");
	}
...
<form:form commandName="helloForm" name="helloForm" method="POST" id="helloForm" action="/entry"> 
    <!-- Navigation -->
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Family Photo Club</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#services">What to Find?</a>
                    </li>
                    <li>
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                <div class="intro-lead-in">Welcome To Our Photo Studio!!</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Look Below</h2>
                    <h3 class="section-subheading text-muted">Get Togethers,Weedings,Outings & What Not!!</h3>
                </div>
            </div>
            <div class="row text-center">
                <div class="col-md-4">
                    ...
                    <h4 class="service-heading">Get Togethers</h4>
                ...
                <div class="col-md-4">
                    ...
                    <h4 class="service-heading">Weedings</h4>
                    <p class="text-muted">xyz</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                    ...
                    <h4 class="service-heading">Outings</h4>
                    <p class="text-muted">xyz</p>
                </div>
            </div>
        </div>
    ...
    <section id="portfolio" class="bg-light-gray">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Photo Collection</h2>
                    <h3 class="section-subheading text-muted">Here's our collection</h3>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal2" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="${pageContext.request.contextPath}/resources/img/portfolio/startup-framework.png" class="img-responsive" alt="">
                    </a>
                    <div class="portfolio-caption">
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal3" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="${pageContext.request.contextPath}/resources/img/portfolio/treehouse.png" class="img-responsive" alt="">
                    </a>
                    <div class="portfolio-caption">
                        <h4>Treehouse</h4>
                        <p class="text-muted">Website Design</p>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal4" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="${pageContext.request.contextPath}/resources/img/portfolio/golden.png" class="img-responsive" alt="">
                    </a>
                    <div class="portfolio-caption">
                        <h4>Golden</h4>
                        <p class="text-muted">Website Design</p>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal5" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="${pageContext.request.contextPath}/resources/img/portfolio/escape.png" class="img-responsive" alt="">
                    </a>
                    <div class="portfolio-caption">
                        <h4>Escape</h4>
                        <p class="text-muted">Website Design</p>
                ...
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal6" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="${pageContext.request.contextPath}/resources/img/portfolio/dreams.png" class="img-responsive" alt="">
                    </a>
                    <div class="portfolio-caption">
                        <h4>Dreams</h4>
                        <p class="text-muted">Website Design</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">It's just me</h3>
                </div>
            </div>
           <div class="row">
                <%-- <div class="col-sm-4">
                ...
                <div class="col-sm-4" style="left:33%;">
                    <div class="team-member">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">Will respond for sure</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <form name="sentMessage" id="contactForm" novalidate>
                        <div class="row">
                            ...
                            <div class="col-lg-12 text-center">
                                <div id="success"></div>
                                <button type="submit" class="btn btn-xl" onclick="contactSubmit();">Send Message</button>
                            </div>
                        </div>
                    </form>
                </div>
